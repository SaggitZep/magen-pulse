window.MAGEN_STATE = {
  "schema_version": 4,
  "mode": "live",
  "generated_at": "2026-08-17T11:46:44.981414Z",
  ...
  "changes": [
    ...
    {
      "time": "11:15",
      "text": "Strait of Hormuz shipping slows as U . S .- Iran ceasefire nears end",
      "impact": "השפעה מיידית מחושבת: -0.8",
      "direction": "down",
      "source": "cnbc.com",
      "signal_id": "0228b3bc987aa4b8"
    }
  ],
  "signals": [
    {
    ...
    {
      "id": "0228b3bc987aa4b8",
      "name": "Strait of Hormuz shipping slows as U . S .- Iran ceasefire nears end",
      "finding": "דיווח המצביע על רגיעה, הכחשה או הפחתת הסלמה.",
      "category": "regional_escalation",
      "direction": "down",
      "evidence_type": "deescalation",
      "dependency_group": "0228b3bc987aa4b8",
      "strength": 0.54,
      "reliability": 0.56,
      "freshness": 0.365,
      "max_effect": {
  ...
  "health": {
    ...
    "last_success": "2026-08-17T11:46:44.981414Z",
    "sources": {
      "gdelt": {
        "ok": true,
        "items": 150,
