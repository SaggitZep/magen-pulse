window.MAGEN_STATE = {
  "schema_version": 4,
  "mode": "degraded",
  "generated_at": "2026-08-28T21:27:44.454795Z",
  ...
  "health": {
    ...
    "sources": {
      "gdelt": {
        "ok": false,
        "error": "<urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: certificate has expired (_ssl.c:1010)>",
        "carried_forward": 0
      },
      "manual": {
        "ok": true,
